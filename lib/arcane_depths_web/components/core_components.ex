defmodule ArcaneDepthsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ArcaneDepthsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ArcaneDepthsWeb.Gettext, "errors", msg, opts)
    end
  end
